...
import org.solve.design.exception.{InvalidPointException, TourFound, TourNotFoundException}
...
/**
  ...
  *
  */
class WarnsdorffAlgo extends Tours {

  import Tours._
  import WarnsdorffAlgo._
  ...
  override def findPath(
    ...
    if (boardDimension._1 < 1 || boardDimension._2 < 1) {
      ...
      Try {
        ...
        throw TourNotFoundException(PathNotFound)
      } recover {
        case found: TourFound => found.tour
      }
  }
